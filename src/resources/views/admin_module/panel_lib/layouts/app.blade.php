...
<body>
    ...
    <div id="app">
        <div class="main-wrapper main-wrapper-1">
            ...
            @include('admin_module.panel_lib.includes.topbar')
            @include('admin_module.panel_lib.includes.sidebar')
            @yield('content')
        </div>
    </div>
  ...
  <script src="{{ asset('src/public/admin/js/page/multiple-upload.js') }}"></script>
    ...
    <script src="{{ asset('src/public/admin/js/page/create-post.js') }}"></script>
    <!-- Template JS File -->
